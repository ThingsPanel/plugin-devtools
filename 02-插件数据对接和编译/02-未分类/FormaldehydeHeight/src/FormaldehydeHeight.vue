<template>
  <div class="chart-all">
    <div class="chart-top">
      <div style="color: #fff; margin-top: 10px">甲醛浓度当日最高值</div>
      <div style="color: #5b92ff">Maximum formaldehyde concentration of the day</div>
    </div>
      ...
      getData() {
        ...
        for (var i = 0; i < this.fields.length; i++) {
          if (this.theTime == this.fields[i].systime.substr(0, 10)) {
            if (this.hValue < this.fields[i].formaldehyde) {
              this.hValue = this.fields[i].formaldehyde;
            }
          }
        }
        this.initChart();
